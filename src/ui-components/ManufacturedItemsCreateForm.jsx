...
export default function ManufacturedItemsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          await DataStore.save(new ManufacturedItems(modelFields));
          if (onSuccess) {
      ...
      {...rest}
      {...getOverrideProps(overrides, "ManufacturedItemsCreateForm")}
    >
      <TextField
        label="Barcode"
        isRequired={false}
